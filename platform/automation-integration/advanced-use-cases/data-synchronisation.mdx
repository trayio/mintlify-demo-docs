...
- Scheduled trigger: If your software service doesn’t offer real-time triggering or you do not wish to sync in real time, you can use a [Scheduled trigger](/connectors/triggers/scheduled-trigger) to pull the data at specified intervals.
